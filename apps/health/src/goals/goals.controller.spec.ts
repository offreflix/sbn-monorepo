...
describe('GoalsController', () => {
  ...
  describe('create', () => {
    it('should create a goal', async () => {
      ...
      const result = await controller.create(
        { dailyCalorieGoal: 2000, proteinGoalG: 150, carbsGoalG: 200, fatGoalG: 60 },
        'u1',
      );
    ...
    it('should throw BadRequestException when x-user-id missing', () => {
      expect(() =>
        controller.create({ dailyCalorieGoal: 2000, proteinGoalG: 150, carbsGoalG: 200, fatGoalG: 60 }, undefined),
  ...
  describe('update', () => {
    it('should update a goal', async () => {
      ...
      const result = await controller.update('g1', { dailyCalorieGoal: 1800 }, 'u1');
      expect(mockGoalsService.update).toHaveBeenCalledWith('g1', 'u1', { dailyCalorieGoal: 1800 });
      expect(result).toEqual(mockGoal);
    });
  });
